...
# Noah Winters
# FEB 2023
# Originally writte by Jason Kwong (https://github.com/kwongj/fa-rename)
# Renames fasta headers based on a tab-delimited file containing [oldname] [newname]
	...
	with open(f, 'r') as fasta:
		...
		for line in fasta:
			...
			if not line or line[0] == '>':	
				continue
			if bool(re.search('[^ACTGactgNnMmRrWwSsYyKkVvHhDdBb?\-]', line)):	# Check if there are non-nucleotide characters in sequence, added iupac ambiguity codes
				return False
	return True
